  ...
  return (
    <div className="instruction-container">
      <div className="instruction-box">
        ...
        <p className="instruction-text">
          You will see some information about the child and an image of the child's handwriting, then you will be asked to decide whether the individual is at high or low risk of dysgraphia.
        </p>
        <p className="instruction-text">
        ...
        <p className="instruction-text">
          Make your best judgment based solely on the information provided.
        </p>
        <p className="instruction-text">
